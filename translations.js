const translations = {
    pt: {
        ...
        'project-1-title': 'DEMLP (em andamento)',
        'project-1-description': 'Modelo DE-MLP para detecção e classificação de cálculos renais em tomografias computadorizadas, utilizando TensorFlow com suporte a GPU. Projeto de pesquisa do mestrado.',
    ...
    en: {
        ...
        'project-1-title': 'DEMLP (in progress)',
        'project-1-description': 'DE-MLP model for kidney stone detection and classification in CT scans, using TensorFlow with GPU support. Master\'s research project.',
