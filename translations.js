const translations = {
    pt: {
        ...
        'project-1-description': 'Baseado em minha Iniciação Científica: DE-MLP. Teste para como diferentes abordagens de Ciência de Dados afetam um modelo para detecção e classificação de cálculos renais em tomografias computadorizadas, utilizando TensorFlow com suporte a GPU. Projeto de pesquisa do mestrado.',
    ...
    en: {
        ...
        'project-1-title': 'DEMLP',
        'project-1-description': 'Based on my Undergraduate Research: DE-MLP. Testing how different Data Science approaches affect a model for kidney stone detection and classification in CT scans, using TensorFlow with GPU support. Master\'s research project.',
