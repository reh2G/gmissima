const translations = {
    pt: {
        ...
        'project-1-description': 'Baseado em minha Iniciação Científica: DE-MLP. Pesquisa sobre como diferentes abordagens de Ciência de Dados afetam um modelo para detecção e classificação de cálculos renais em tomografias computadorizadas, utilizando TensorFlow com suporte a GPU. Projeto de pesquisa do mestrado.',
        'project-2-title': 'Simulação de Robô',
        'project-2-description': 'Simulação robótica desenvolvida em Python para disciplina acadêmica na FEI. Modelagem e controle de movimentos autônomos.',
        'project-3-title': 'Bússola Assembly',
        'project-3-description': 'Implementação de uma bússola digital em linguagem Assembly. Projeto de baixo nível desenvolvido durante a graduação na FEI.',
        'project-4-title': 'PEL219-Tarefas',
        'project-4-description': 'Exercícios e tarefas da disciplina do Mestrado: Redes Neurais Artificiais e Aprendizado Profundo.',
        'project-5-title': 'PEL202-Projeto 1',
        'project-5-description': 'Projeto 1 desenvolvido na disciplina do Mestrado: Fundamentos de Inteligência Artificial.',
        'project-6-title': 'PEL202-Projeto 2',
        'project-6-description': 'Projeto 2 desenvolvido na disciplina do Mestrado: Fundamentos de Inteligência Artificial.',
    ...
    en: {
        ...
        'project-1-title': 'DEMLP',
        'project-1-description': 'Based on my Undergraduate Research: DE-MLP. Research on how different Data Science approaches affect a model for kidney stone detection and classification in CT scans, using TensorFlow with GPU support. Master\'s research project.',
        'project-2-title': 'Robot Simulation',
        'project-2-description': 'Robotic simulation developed in Python for an academic course at FEI. Autonomous movement modeling and control.',
        'project-3-title': 'Assembly Compass',
        'project-3-description': 'Digital compass implementation in Assembly language. Low-level project developed during the undergraduate program at FEI.',
        'project-4-title': 'PEL219-Tasks',
        'project-4-description': 'Exercises and tasks from the Master\'s degree course: Artificial Neural Networks and Deep Learning.',
        'project-5-title': 'PEL202-Project 1',
        'project-5-description': 'Project 1 developed in the Master\'s degree course: Fundamentals of Artificial Intelligence.',
        'project-6-title': 'PEL202-Project 2',
        'project-6-description': 'Project 2 developed in the Master\'s degree course: Fundamentals of Artificial Intelligence.',
