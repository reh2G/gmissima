const translations = {
    pt: {
        ...
        'skill-2': 'C / C++ / C# (.NET)',
        'skill-3': 'Deep Learning (TensorFlow / PyTorch)',
        'skill-4': 'Visão Computacional & Processamento de Imagens',
        'skill-5': 'Pesquisa Científica & Escrita Acadêmica',
        'skill-6': 'Ciência de Dados & Análise de Dados',
    ...
    en: {
        ...
        'skill-2': 'C / C++ / C# (.NET)',
        'skill-3': 'Deep Learning (TensorFlow / PyTorch)',
        'skill-4': 'Computer Vision & Image Processing',
        'skill-5': 'Scientific Research & Academic Writing',
